...
window.location.href = 'login.php';	
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            document.getElementById("grandtotal").getElementsByTagName("p")[0].innerHTML = "Grand Total: " + parseFloat(((parseFloat(Number(total).toFixed(2)) + Number(document.getElementsByName("remainingbalance")[0].value))-(Number(document.getElementById("discount").value))).toFixed(2));
      document.getElementsByName("grandtotal")[0].value = parseFloat(((parseFloat(Number(total).toFixed(2)) + Number(document.getElementsByName("remainingbalance")[0].value))-(Number(document.getElementById("discount").value))).toFixed(2));
        }
